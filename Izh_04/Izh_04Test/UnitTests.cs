...
namespace Izh_04Test
{
    ...
    public class Izh04BasicCodingTests
    {
        ...
        [TestCase("AsdfeAd", "", ExpectedResult = "AsdfeAd")]
        [TestCase("", "Assqaasssqs", ExpectedResult = "Assqaasssqs")]
        [TestCase("AsdfeAd", "Assqaasssqs", ExpectedResult = "AsdfeAdqaaq")]
        [TestCase("123456", "7890", ExpectedResult = "1234567890")]
        ...
        [TestCase(new int[] { 7, 1, 2, 3, 4, 5, 6, 7, 68, -69, 71, 15, 17 }, 0, ExpectedResult = new int[] { })]
        ...
        [TestCase(8, 14, 3, 8, ExpectedResult = 112)]
        ...
        [TestCase(8, 14, -3, 8)]
        [TestCase(8, 14, 3, -8)]
        public void CheckInsertNumberArgumentOutOfRangeException(int firstNumber, int secondNumber, int startIndex, int endIndex)
        {
        ...
        [TestCase(12, false, ExpectedResult = 21)]
        [TestCase(513, false, ExpectedResult = 531)]
        [TestCase(2017, false, ExpectedResult = 2071)]
        [TestCase(414, false, ExpectedResult = 441)]
        [TestCase(144, false, ExpectedResult = 414)]
        [TestCase(1234321, false, ExpectedResult = 1241233)]
        [TestCase(1234126, false, ExpectedResult = 1234162)]
        [TestCase(3456432, false, ExpectedResult = 3462345)]
        [TestCase(10, false, ExpectedResult = -1)]
        [TestCase(20, false, ExpectedResult = -1)]
